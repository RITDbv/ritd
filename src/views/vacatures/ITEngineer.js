...
export default function ITEngineer() {
  React.useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="wrapper">
        <MainHeader color="squares" btn="color" title="IT Engineer" />
        <div className="main">
              ...
              <Row className="justify-content-between">
                <Col className="mb-5 mb-lg-0" lg="12">
                  <h2 className="text-white font-weight-bold uppercase mt-5">
                    Vacature: IT Engineer Consultant
                  </h2>
                  <ul>
                  ...
                  <ul>
                    <li>
                      <p className="text-white mt-4">
                        Ontwerpen en implementeren van IT-oplossingen op maat
                  ...
                  <ul>
                    ...
                    <li>
                      <p className="text-white mt-4">
                        Data: Hadoop, Spark, Python (pandas, numpy), SQL,
                        Redshift, BigQuery
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p className="text-white mt-4">
                        Architectuur: TOGAF, ArchiMate, microservices, SOA
                      </p>
                    </li>
                    <li>
                      <p className="text-white mt-4">
